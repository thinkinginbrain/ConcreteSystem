...
let Index = {
    ...
    ec01_line_tiobe() {
        ...
        chart.setOption({
            ...
            series: [
                {"name": "传感器1", data: [1, 2, 1, 1, 12, '-', 0]},
                {"name": "传感器2", data: [2, 1, 2, 2, 1, 1, 1]},
                {"name": "传感器3", data: [3, 4, 3, 3, 2, 2, 3]},
                {"name": "传感器4", data: [4, 7, 5, 9, 27, 21, 0]},
                {"name": "传感器5", data: [5, 10, '-', '-', '-', '-', 0]},
                {"name": "传感器6", data: [6, 5, 6, 7, 23, '-', 0]},
                {"name": "传感器7", data: [7, 8, 8, 8, 17, '-', 0]},
                {"name": "传感器8", data: [8, 6, 4, 5, '-', '-', 0]},
                {"name": "传感器9", data: [9, '-', '-', 6, '-', '-', 0]},
                //{"name": "传感器1", data: [10, 3, 36, 44, '-', '-', 0]},
