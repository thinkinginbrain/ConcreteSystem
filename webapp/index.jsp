...
<!--                     <li><a href="javascript:;" target="mainframe"><span></span></a></li> -->
                    <li><a href="${pageContext.request.contextPath}/ModelServlet?act=select" target="mainframe"><span>模型管理</span></a></li>
            ...
            <li class="nav-item">
                ...
                <ul>
                   <!--  <li><a href="javascript:;" target="mainframe"><span>菜单管理</span></a></li> -->
                    ...
                    <li><a href="${pageContext.request.contextPath}/LogServlet?act=select" target="mainframe"><span>日志管理</span></a></li>
                </ul>
            </li>
