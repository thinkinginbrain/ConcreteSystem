...
<div>
	<form action="${pageContext.request.contextPath}/UserServletSimple?act=update" method="post" style="width:100%;text-align:center;">
        ...
        <table class="wzc-table">
            ...
            <tr>
                ...
                <td colspan='2'><a href="${pageContext.request.contextPath}/UserServletSimple?act=select" class="wzc-btn" style="width: 200px;">返回</a></td>
            </tr>
		</table>
	</form>
</div>
