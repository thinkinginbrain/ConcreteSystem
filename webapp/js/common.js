...
const Cfg = {
    ...
    chartRefreshPeriod: 0.2, // 图表刷新周期（秒）settings.chartRefreshPeriod || 
...
const Public = {
     ...
     * @param charts
     * @param t 默认刷新时间（秒）
     * @param noRefresh 无需刷新的图表 t = Cfg.chartRefreshPeriod (t || Cfg.chartRefreshPeriod) * 10)
